...
function init() {
  if (window.location.hostname == "rustsense.pub") {
...
function openPopup(assignment) {
  ...
  <hr>
  <p style="font-size: 12px">Made by: <a target="_blank" href="https://github.com/wotle">wotle</a> on Github | Website: <a target="_blank" href="https://rustsense.pub">rustsense.pub</a> | Website: <a target="_blank" href="https://rustsense.pub">wotle/edpuzzle-answers</a></p>
  <p style="font-size: 12px">Licenced under Wotle <a target="_blank" href="https://rustsense.pub">GNU GPL v3</a>. Do not SHARE.</p>
  <p style="font-size: 12px">Available now from our <a target="_blank" href="https://rustsense.pub/discord.html">Discord server</a>: <i> haiiii :3 </i></p>`;
